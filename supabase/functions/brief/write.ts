...
- ORDER: lead with today's SCHEDULE (the events and time-blocked tasks), then mention what needs attention (due today / overdue) toward the END — what matters first should come first.
