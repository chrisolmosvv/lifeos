...
export default function RecipePage({ recipeId, cookOnOpen, stageOnOpen, onBack, onEdit, onDelete, onCooked }) {
  ...
  useEffect(() => { if (stageOnOpen) { setCooking(false); setStaging("cooked"); } }, [stageOnOpen]);
